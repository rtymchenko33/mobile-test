...
async function authorize(codeDigit) {
    ...
    // Знаходимо кнопку BankID НБУ
    // ⚠️ У кнопки немає accessibilityIdentifier, використовуємо Class Chain по name
    // У page source: name="BankID НБУ  . " (з двома пробілами перед крапкою)
